...
const projects = [
  ...
  },
  {
    ...
    tag: 'Control Theory',
    description: 'Single and double cart-pole. Balance it with LQR, cascade PID, or an evolved neural net; the double holds all four equilibria. Flip to Realistic mode for noisy encoders, an EKF estimator, and actuator lag — engineering-grade, not just an animation.',
    tech: ['LQR / LQG', 'PID', 'Neuroevolution', 'Kalman filter'],
